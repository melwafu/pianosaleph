...
function Children(categories) {
    ...
    const [dataTable, setDataTable] = useState(categories);
...
function Category({categories}) {
    const children = Children(categories);
    return (
        <AdminLayout head="Categories" children={children} />
    );
}
